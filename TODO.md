...
- [ ] **Explore Advanced VAE Architectures for Better Accuracy-Disentanglement Trade-off**
  ...
  **Candidates to Evaluate:**
  1. **$\beta$-TCVAE (Total Correlation VAE)**
  ...
  **Next Steps:**
  ...
  - [ ] Update `main.py` and `factory.py` to support `--arch tc_vae`.
  - [ ] Run a WandB sweep comparing `beta_vae` vs `tc_vae` across identical latent dimensions to measure Pareto frontier improvement (MSE vs MIG).
