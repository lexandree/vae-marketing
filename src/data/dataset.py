...
EXTERNAL_STIMULUS_SCHEMA = {
    ...
    # affected_categories can remain uncasted string lists or categorical lists depending on Polars support
}
...
BEHAVIORAL_SHIFT_SCHEMA = {
    ...
    "qualitative_nature": pl.Categorical, # 'Stockpiling', 'Trading Up', 'Brand Switching', 'No Change'
