...
def validate_and_load_data(transactions_path: Path, products_path: Path) -> tuple[pl.DataFrame, pl.DataFrame]:
...
def main() -> None:
    ...
    try:
        ...
        logger.info(f"Splits shapes - Train: {train_df.shape}, Val: {val_df.shape}, Test: {test_df.shape}")
